...
<body class="nav-md">
              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <form class="form-label-left input_mask" method="post" action="?c=guardar">
                    <input type="hidden" name="fechaID" value="<?php echo $nuevoFecha->idFecha ?>">
  ...
  <!-- FastClick -->
  <script src="View/plantilla-proyecto/vendors/fastclick/lib/fastclick.js"></script>
  <!-- NProgress -->
  <script src="View/plantilla-proyecto/vendors/nprogress/nprogress.js"></script>
  <!-- Custom Theme Scripts -->
  <script src="View/plantilla-proyecto/build/js/custom.min.js"></script>
</body>
