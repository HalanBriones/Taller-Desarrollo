            ...
            <div class="col-md-12 col-sm-12  ">
              <div class="x_panel">
                ...
                <div class="x_content"> 
                    ...
                    <p> Filtrar por:</p>
                  <div class="row">  
                    &ensp;<select class="form-control col-3" value="Edad">
                      <option disabled selected hidden>Edad</option>
                      <option>Menores de 30 años</option>
                      <option>Menores de 40 años</option>
                      <option>Menores de 50 años</option>
                    </select> &emsp;
                    <select class="form-control col-3">
                      <option disabled selected hidden>Cursos</option>
                      <option>Ninguna</option>
                      <option>Mas de 2</option>
                      <option>Mas de 4</option>
                      <option>Mas de 6</option>
                    </select>
                  </div>
                  <br>
                  <br>
                    <button style="border-radius: 0px;" class="btn btn-success">Filtrar</button>
                    <br>
                    <br>
                    ...
                    <table class="table table-striped jambo_table bulk_action">
                      <thead>
                        <tr class="headings">
                          ...
                          <th class="column-title" style="display: table-cell;">Comuna</th>
                          ...
                          <th class="column-title no-link last" style="display: table-cell;"><span class="nobr">Ficha
                              Personal</span>
                          <th class="column-title no-link last" style="display: table-cell;"><span class="nobr">Experiencia brigadista  </span>
                      ...
                      <tbody>
                        ...
                        <tr class="odd pointer">
                          ...
                          <td class=" ">Rivera</td>
                          <td class=" ">21 Años</td>
                          <td class=" ">Los Angeles</td>
                          <td class=" ">990701744</td>
                          <td class=" last"><a href="fichaPersonal.html">Ver</a>
                          </td>
                          <td class=" ">0</td>
